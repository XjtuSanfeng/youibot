package com.youibot.docrobo.robo.session;
...
import com.youibot.docrobo.robo.contact.activity.UserProfileActivity;
import com.youibot.docrobo.robo.session.action.AVChatAction;
import com.youibot.docrobo.robo.session.action.FileAction;
import com.youibot.docrobo.robo.session.action.GuessAction;
import com.youibot.docrobo.robo.session.action.RTSAction;
import com.youibot.docrobo.robo.session.action.SnapChatAction;
import com.youibot.docrobo.robo.session.action.TipAction;
import com.youibot.docrobo.robo.session.activity.MessageHistoryActivity;
import com.youibot.docrobo.robo.session.activity.MessageInfoActivity;
import com.youibot.docrobo.robo.session.extension.CustomAttachParser;
import com.youibot.docrobo.robo.session.extension.CustomAttachment;
import com.youibot.docrobo.robo.session.extension.GuessAttachment;
import com.youibot.docrobo.robo.session.extension.RTSAttachment;
import com.youibot.docrobo.robo.session.extension.SnapChatAttachment;
import com.youibot.docrobo.robo.session.extension.StickerAttachment;
import com.youibot.docrobo.robo.session.search.SearchMessageActivity;
import com.youibot.docrobo.robo.session.viewholder.MsgViewHolderAVChat;
import com.youibot.docrobo.robo.session.viewholder.MsgViewHolderDefCustom;
import com.youibot.docrobo.robo.session.viewholder.MsgViewHolderFile;
import com.youibot.docrobo.robo.session.viewholder.MsgViewHolderGuess;
import com.youibot.docrobo.robo.session.viewholder.MsgViewHolderRTS;
import com.youibot.docrobo.robo.session.viewholder.MsgViewHolderSnapChat;
import com.youibot.docrobo.robo.session.viewholder.MsgViewHolderSticker;
import com.youibot.docrobo.robo.session.viewholder.MsgViewHolderTip;
...
//            p2pCustomization.backgroundUri = "android.resource://com.netease.nim.robo/drawable/bk"

package com.youibot.docrobo.robo.receiver;
...
import com.youibot.docrobo.robo.main.helper.CustomNotificationCache;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals(intent.getAction())) {
            ...
            try {
                ...
                LogUtil.e("robo", e.getMessage());
            }

            // 处理自定义通知消息
            LogUtil.i("robo", "receive custom notification: " + notification.getContent() + " from :" + notification.getSessionId() + "/" + notification.getSessionType());
        }
    }
}
